...
def validate_image(image: Path) -> None:
    ...
    require(usb, "write /config/usb_gadget/g1/bDeviceClass 0xEF", "packaged init.recovery.usb.rc")
    require(usb, "write /config/usb_gadget/g1/bDeviceSubClass 0x02", "packaged init.recovery.usb.rc")
    require(usb, "write /config/usb_gadget/g1/bDeviceProtocol 0x01", "packaged init.recovery.usb.rc")
    ...
    require(flags, "metadata_encryption=aes-256-xts:wrappedkey_v0", "packaged twrp.flags")
